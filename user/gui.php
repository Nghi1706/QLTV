...
<body class="goto-here">
  <div class="py-1 bg-primary">
        ...
        <div class="col-lg-12 d-block">
          <div class="row d-flex">
            <div class="col-md pr-4 d-flex topper align-items-center">
              ...
              <span class="text">+84 966862xxx</span>
            </div>
            <div class="col-md pr-4 d-flex topper align-items-center">
              <div class="icon mr-2 d-flex justify-content-center align-items-center"><span
                  class="icon-paper-plane"></span></div>
              <span class="text">myteam1706@email.com</span>
            </div>
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              <h1 class="mb-2">Sách là nguồn gốc của tri thức</h1>
	              <h2 class="subheading mb-4">Hãy đọc sách mỗi ngày</h2>
	            </div>
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-sm-12 ftco-animate text-center">
	              <h1 class="mb-2">Nguồn gốc rõ ràng<br>100% sách mới</h1>
	              <h2 class="subheading mb-4">Giao hàng từ 3-5 &amp; ngày</h2>
	            </div>
          ...
          <div class="col-md-4 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                ...
                <span>Cho đơn hàng từ 100k</span>
              </div>
            </div>      
          </div>
          <div class="col-md-4 text-center d-flex align-self-stretch ftco-animate">
    ...
    <section class="ftco-section">
		...
		<section class="ftco-section img" style="background-image: url(../images/sales.jpg);">
    	<div class="container">
				<div class="row justify-content-end">
          <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
          	<span class="subheading">Best Price For You</span>
            <h2 class="mb-4">Deal of the day</h2>
            <h3><a href="#">Nóng giận là bản năng, tĩnh lặng là bản lĩnh</a></h3>
            <span class="price">105.000đ <br><a href="#">now 85.000đ only</a></span>
