    ...
    <section class="ftco-section ftco-cart">
			<div class="container">
                ...
                $phone = $_SESSION['phone'];
                  $p-> cart_sp("select sanpham.name, sanpham.cost, sanpham.link_image,sanpham.id from cart inner join guest_login on cart.id_user = guest_login.phone inner join sanpham on cart.id_sp = sanpham.id where id_user='$phone'");
            ...
            <form>
            <input type="submit" value="buynow" name="buynow"class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;"/>
            </form><?php
            switch (isset($_REQUEST['buynow']))
            {
                case "buynow":
                {
                  $phone = $_SESSION['phone'];
                  $date = date("Y-m-d");
                  $p->edit("INSERT INTO bill (id_user, id_sp, date)
                  SELECT id_user, id_sp, date
                  FROM cart
                  WHERE id_user=$phone");
                  echo "<script>alert('đơn hàng đã lập thành công')</script>";
                  $p->edit("delete from cart
                  WHERE id_user=$phone");
                  $p->edit("UPDATE bill SET date='$date' WHERE id_user=$phone");
                    break;
                }
            }
