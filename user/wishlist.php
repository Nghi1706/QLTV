    ...
    <section class="ftco-section ftco-cart">
			<div class="container">
                ...
                $phone = $_SESSION['phone'];
                  $p-> wish_sp("select sanpham.name, sanpham.cost, sanpham.link_image,sanpham.id from wislist inner join guest_login on wislist.id_user = guest_login.phone inner join sanpham on wislist.id_sp = sanpham.id where id_user='$phone'");
