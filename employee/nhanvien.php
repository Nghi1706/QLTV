...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <section class="ftco-section ftco-cart">
			<div class="container">
                ...
                $p = new user();
                $p->connect();
                $p->QL_nv('select * from employee_login');
                ?>
						  </tbody>
						  </table>
    ...
    <section class="ftco-section ftco-cart">
			<div class="container">
                ...
                <h2>Thêm Nhân viên</h2>
						    <form class="col-7" action="add_kh.php" method="get">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="cost" name="sdt" required class="form-control">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">địa chỉ</label>
                            <input type="number" id="sl" name="address" required class="form-control">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">password</label>
                            <input type="number" id="link_image" name="password" required class="form-control">
                        </div>
